...
Actually the boxplot codeblock won't knit and I can't figure out why. I've commented out the code and added the images to the working directory so that the boxplots will show and the file can be knitted as a temporary measure

![Lost boxplot 1: Male Testosterone~PhysActive](Male1.png)

![Lost boxplot 2: Male Testosterone~PhysActive](Male2.png)

![Lost boxplot 3: Female... Nothing there!](Female.png)
#```{r Boxplots for testosterone}

NHANES_adult_male <- base::subset(NHANES_adult, (Sex == "Male"))
NHANES_adult_female <- base::subset(NHANES_adult, (Sex == "Female"))
